 ...
 *  - Space time: marking space-time interface, checking the presence of a key in a std::vector
 * ---------------------------------------------------------------------
 *
 * Author: Eldar Khattatov, University of Pittsburgh, 2016 - 2017,
 * 		 : Manu Jayadharan, University of Pittsburgh, 2019-2020
 */
...
namespace dd_biot
{
    						...
    						const Point<dim> &p2, std::vector<Number> &faces_per_interface)
    {
        ...
        //  0 - for outside except 101- outside left
        //Manu modified: unit square: left=4, bottom=1, right=2, top=3. For outer boundary add 100, eg: outer left=104
